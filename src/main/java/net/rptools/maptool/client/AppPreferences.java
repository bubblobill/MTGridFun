...
import net.rptools.maptool.model.GridType;
...
public class AppPreferences {
  ...
  private static final GridType DEFAULT_DEFAULT_GRID_TYPE = GridType.SQUARE;
  ...
  public static String getDefaultGridType() {
    return prefs.get(KEY_DEFAULT_GRID_TYPE, DEFAULT_DEFAULT_GRID_TYPE.oldName());
  }
