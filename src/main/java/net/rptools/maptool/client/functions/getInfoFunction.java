...
public class getInfoFunction extends AbstractFunction {
  ...
  private JsonObject getMapInfo() throws ParserException {
    ...
    ginfo.addProperty("cell offset width", zone.getGrid().getCellGridOffset().getWidth());
    ginfo.addProperty("cell offset height", zone.getGrid().getCellGridOffset().getHeight());
    ginfo.addProperty("size", zone.getGrid().getSize());
    ginfo.addProperty("x offset", zone.getGrid().getGridOffsetX());
    ginfo.addProperty("y offset", zone.getGrid().getGridOffsetY());
