...
public class ZoneRenderer extends JComponent
  ...
  public void renderPath(
    ...
    if (path.getCellPath().get(0) instanceof CellPoint) {
      ...
      Dimension cellOffset = zone.getGrid().getCellGridOffset();
      ...
      if (grid.getCapabilities().isPathLineSupported()) {
        ...
        if (grid.isHex()) {
          ...
          lineOffset =
              new ZonePoint(
                  footprintBounds.x + footprintBounds.width / 2 - grid.getGridOffsetX(),
                  footprintBounds.y + footprintBounds.height / 2 - grid.getGridOffsetY());
        }
  ...
  public void moveGridBy(int dx, int dy) {
    int gridOffsetX = zone.getGrid().getGridOffsetX();
    int gridOffsetY = zone.getGrid().getGridOffsetY();
    ...
    zone.getGrid().setGridOffset(gridOffsetX, gridOffsetY);
    repaintDebouncer.dispatch();
  }
